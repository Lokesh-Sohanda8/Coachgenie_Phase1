...
//   UserPlus, FileCheck, BookOpen, ClipboardList, IndianRupee, Bell, Sparkles,
// };

// const NAV_ITEMS = [
//   { label: "Dashboard",  href: "/dashboard",  icon: "LayoutDashboard" },
//   { label: "Leads",      href: "/leads",      icon: "UserPlus"        },  // ← ADD
//   { label: "Admissions", href: "/admissions", icon: "FileCheck"       },  // ← ADD
...
//   const visibleItems = NAV_ITEMS.filter((item) => MODULE_ROLES[item.href]?.includes(role) ?? true);
