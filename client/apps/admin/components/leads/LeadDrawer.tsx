...
// import { X, Phone, Mail, User, GraduationCap, ExternalLink } from "lucide-react";
...
//             <p className="text-sm text-muted-foreground">{lead.grade} · {lead.subject}</p>
//           </div>
...
//                       active ? `${cfg.color} ${cfg.bg} ${cfg.border} shadow-sm` : "hover:bg-accent"
//                     )}
//                   >
//                     {cfg.label}
//                   </button>
...
//               { icon: User,          label: "Parent", value: lead.parentName },
//               { icon: GraduationCap, label: "Source", value: lead.source.replace(/_/g, " ") },
...
//     // NEW
//     { icon: Phone,         label: "Parent Contact",    value: lead.parentContactNumber },

//     // NEW
//     { icon: GraduationCap, label: "School Name",       value: lead.schoolName },
