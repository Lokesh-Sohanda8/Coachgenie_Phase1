...
//   const stats = [
//     { label: "Total Collected", value: `₹${(totalCollected/100000).toFixed(1)}L`, icon: IndianRupee, color: "text-emerald-600", bg: "bg-emerald-50 dark:bg-emerald-950" },
//     { label: "Outstanding",     value: `₹${(totalOutstanding/100000).toFixed(1)}L`, icon: TrendingUp, color: "text-amber-600", bg: "bg-amber-50 dark:bg-amber-950" },
//     { label: "Overdue",         value: overdue.length.toString(), icon: AlertCircle, color: "text-red-600", bg: "bg-red-50 dark:bg-red-950" },
//     { label: "Total Invoices",  value: invoices.length.toString(), icon: Clock, color: "text-blue-600", bg: "bg-blue-50 dark:bg-blue-950" },
//   ];
...
//         {stats.map((s, i) => (
//           <div key={s.label} className="rounded-xl border bg-card p-5 shadow-sm fade-in" style={{ animationDelay:`${i*60}ms` }}>
...
//       <InvoiceTable invoices={invoices} statusFilter={statusFilter} />
//     </div>
//   );
// }
...
//   const totalCollected   = summary.total_collected   ?? invoices.reduce((s, i) => s + i.amountPaid, 0);
//   const totalOutstanding = summary.total_due         ?? invoices.reduce((s, i) => s + Math.max(0, i.amountDue - i.amountPaid), 0);
//   const overdueCount     = summary.overdue_count     ?? invoices.filter(i => i.status === "overdue").length;
//   const totalInvoices    = summary.total_invoices    ?? invoices.length;
...
//     if (monthFilter !== "ALL")
//       list = list.filter(i => i.dueDate?.startsWith(monthFilter));
