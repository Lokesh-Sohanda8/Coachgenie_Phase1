...
//               <span className="text-sm text-muted-foreground">{lead.grade} · {lead.subject}</span>
//             </div>
//           </div>
//         </div>
...
//                       active ? `${cfg.color} ${cfg.bg} ${cfg.border}` : "hover:bg-accent text-muted-foreground"
//                     )}
//                   >
//                     <span className={cn("h-1.5 w-1.5 rounded-full", active ? cfg.color.replace("text-", "bg-") : "bg-muted-foreground/40")} />
//                     {cfg.label}
